...
class BillingService extends ChangeNotifier {
  ...
  /// The monthly ($rc_monthly) package shown on the push paywall.
  Package? get pipMonthlyPackage => _currentOffering?.monthly;

  /// Localized price for the monthly product (e.g. "$4.99").
  String? get pipMonthlyPriceLabel =>
      pipMonthlyPackage?.storeProduct.priceString;

  /// Buys the monthly plan. Grants the same Pro entitlement as the annual plan.
